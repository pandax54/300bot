/**
 * Redeclaration of koa-body modules type definitions to omit its ambient koa module declaration,
 * that block custom typings of Koa requests body.
 * @see https://github.com/koajs/koa-body/issues/198
 */
